 ...
 * crawler.js
 *
 * Generic chain crawler that adds and removes transactions to the db
 */
...
class Crawler {
  ...
  start(height, hash) {
    ...
    //TODO: remove test    this._pollForNewBlocks()
    //TODO: remove test    this._expireMempoolTransactions()
  }
